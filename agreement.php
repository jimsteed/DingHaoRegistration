...
<input type="radio" name="status" value="new"> New Family
</P>
<P>
...
<P style="margin-bottom: 10px">
<input type="checkbox" name="insuranceWaiver"> I hereby certify that our family and guests will provide our own personal accident and health insurance when attending CCAGP related functions.
</P>
<P>
